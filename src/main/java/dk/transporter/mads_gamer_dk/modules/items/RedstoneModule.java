...
public class RedstoneModule extends SimpleModule
{
    ...
    public RedstoneModule(final TransporterAddon addon) {
        this.addon = addon;
    }
    ...
    public String getDisplayValue() {
        DisplayValue = addon.getItems().getItemByID(18).getAmount().toString();
        return DisplayValue;
    }
    ...
    public String getDescription() {
        return "Hvor meget redstone du har i din transporter.";
    }
