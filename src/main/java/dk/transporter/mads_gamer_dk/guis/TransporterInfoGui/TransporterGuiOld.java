...
public class TransporterGuiOld extends GuiScreen {
    ...
    public TransporterGuiOld(TransporterAddon addon, Items items) {
        this.addon = addon;
        this.items = items;
        ...
        for(TransporterItems item : items) {
            if(slot >= 0 && slot <= 10){
                if(false) {
                    ...
                    LabyMod.getInstance().getDrawUtils().drawItem(itemStack, col1+16, (this.height - (this.height / 5)) - (slot * yDistance) + 5, String.valueOf(this.items.getItemByID(slot).getAmount()));
                ...
                if(false) {
                    ...
                    LabyMod.getInstance().getDrawUtils().drawItem(itemStack, col2+16, (this.height - (this.height / 5)) - ((slot-11) * yDistance) + 5, String.valueOf(this.items.getItemByID(slot).getAmount()));
                ...
                if(false) {
                    ...
                    LabyMod.getInstance().getDrawUtils().drawItem(itemStack, col3+16, (this.height - (this.height / 5)) - ((slot-22) * yDistance) + 5, String.valueOf(this.items.getItemByID(slot).getAmount()));
