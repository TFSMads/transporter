...
public class TransporterAddon extends AddonMain {
    ...
    public void onEnable() {
        ...
        try {
            ...
            DropDownElement<FormatingUtils.FORMATTING_MODE> dropDownElement = new DropDownElement<>("Tal Formatering", "selectedNumberFormat", dropDownMenu, new ControlElement.IconData(
                Material.PAPER), (DropDownElement.DropDownLoadValue<FormatingUtils.FORMATTING_MODE>) value -> {
            ...
            ListContainerElement advancedSettings = new ListContainerElement("Avanceret", new ControlElement.IconData(
                Material.DIODE));

            ListContainerElement loggerOptionsElement = new ListContainerElement("Logger indstillinger", new ControlElement.IconData(
                Material.PAPER));
            ...
            DropDownElement<Logger.LOG_LEVEL> logLevelDropDownElement = new DropDownElement<>("Log Level", "logLevel", logLevelDropDownMenu, new ControlElement.IconData(
                Material.PAPER), Logger.LOG_LEVEL::valueOf, loggerOptions);
            ...
            DropDownElement<Logger.DEBUG_LEVEL> debugLevelDropDownElement = new DropDownElement<>("Debug Level", "debugLevel", debugLevelDropDownMenu, new ControlElement.IconData(
                Material.PAPER), Logger.DEBUG_LEVEL::valueOf, loggerOptions);
            ...
            BooleanElement printStackTraceElement = new BooleanElement("Print stack trace", loggerOptions, "printStackTrace", new ControlElement.IconData(
                Material.DIODE), Logger.printStackTrace.get());
            ...
            BooleanElement updateItemsElement = new BooleanElement("Opdatere items automatisk", dataManager, "updateItemsFromGithub", new ControlElement.IconData(
                Material.DIODE), true);
            ...
            BooleanElement updateMessagesElement = new BooleanElement("Opdatere beskeder automatisk", dataManager, "updateMessagesFromGithub", new ControlElement.IconData(
                Material.DIODE), true);

            ListContainerElement messagesEditor = new ListContainerElement("Beskeder", new ControlElement.IconData(
                Material.PAINTING));
            ...
            BooleanElement updateBalanceMessagesElement = new BooleanElement("Opdatere balance beskeder automatisk", dataManager, "updateBalanceMessagesFromGithub", new ControlElement.IconData(
                Material.DIODE), true);

            ListContainerElement balanceMessagesEditor = new ListContainerElement("Balance beskeder", new ControlElement.IconData(
                Material.EMERALD));
            ...
            ListContainerElement valueMenu = new ListContainerElement("Værdi indstillinger", new ControlElement.IconData(
                Material.EMERALD));
